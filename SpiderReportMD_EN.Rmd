...
The results of your survey are presented in the plot. For each category, your score is marked in red and is standardized with your classmates. The circle that is marked 50% is the average score across your class. Scores above the 50% mark mean higher foreign language anxiety and scores less than the 50% mark mean lower foreign language anxiety.

```{r plot_gen, warning=FALSE, echo = FALSE}
print(ggradar(case_spider, axis.label.size = 3.75, grid.label.size = 5, group.point.size = 3.5) + theme(legend.position = "none"))
```
